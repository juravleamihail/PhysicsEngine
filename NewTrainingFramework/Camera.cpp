...
Camera::Camera(Vector3 position, Vector3 target, Vector3 up, GLfloat movespeed, GLfloat rotateSpeed, GLfloat near1, GLfloat far1, GLfloat fov, GLfloat deltaTime)
{
